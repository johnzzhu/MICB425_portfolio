...
In-depth sampling and sequencing methods can be found here: [Hawley AK *et al* 2017](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5663217/#b20), "A compendium of multi-omic sequence information from the Saanich Inlet water column" [11]. 
...
```{r message=FALSE}
treesapp.out.dir = "project_2/treesapp_out_gene_tax_abd/"
...
```{r}
load("project_2/mothur_phyloseq.RData")
